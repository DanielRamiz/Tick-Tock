...
## Install
In order to start using the project you need to clone it to your pc. Clone the project with the git command.
```
git clone -b Gulp-Starter-Kit https://github.com/DanielRamiz/Tick-Tock.git new-project
```
